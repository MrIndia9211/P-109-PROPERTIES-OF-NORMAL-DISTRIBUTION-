# THIS ARE SOME PYTHON LIBRARIES
...
import statistics
import random
# CODE FOR READING DATA FROM FILE [DATA.CSV]
df = pd.read_csv("data.csv")
data = df["reading score"].tolist()
# CODE  FOR FINDING MEAN
mean = sum(data) / len(data)
# CODE  FOR FINDING std_deviation
...
# CODE  FOR PRINTING THE DATA OF MEAN,MEDIAN,MODE,STANDARD DEVIATION
